		...
		>
			<div class="relative">
				<h1 bind:this={headingRef} class="text-3xl sm:text-6xl lg:text-7xl text-nowrap font-bold">
					<span
						data-focused={true}
						class="data-[focused=true]:text-brand transition-colors duration-1000 text-muted-foreground"
					>
						Write.
					</span>
					<span
				...
				<p class="text-muted-foreground text-lg text-center mt-4">
					<span
						class={{ 'text-brand': focusedIndex === 0, 'transition-colors duration-1000': true }}
					>
						Write
					</span>
					your code,
					<span
						class={{ 'text-brand': focusedIndex === 1, 'transition-colors duration-1000': true }}
					>
						Build
					</span>
					it into a registry, and
					<span
						class={{ 'text-brand': focusedIndex === 2, 'transition-colors duration-1000': true }}
					>
						Distribute
				...
				<div
					...
					class="border-2 absolute border-brand transition-all duration-1000 data-[visible=false]:opacity-0"
				></div>
					...
					>
						...
						<Terminal.AnimatedSpan delay={3000}>
							<pre><span class="text-muted-foreground"
								...
								>{`
  21                           link: 'text-brand underline-offset-4 hover:underline'
  22                   },
  23                   size: {`}
<span
