...
<Accordion type="single" collapsible>
	...
	<AccordionItem value="q-2">
		...
		<AccordionContent className="flex flex-col gap-4 text-balance">
			**jsrepo** is partially **shadcn** compatible. You can add and update items from **shadcn** with zero configuration needed, however imports are not currently resolved so you will have to update them manually. If you want to make your **jsrepo** registry **shadcn** compatible you can take a look at the <Link href="/docs/outputs/shadcn" className='text-(--tw-prose-links) font-medium underline underline-offset-[3.5px] decoration-[1.5px]'>@shadcn/jsrepo</Link> package.
		</AccordionContent>
	</AccordionItem>
</Accordion>
